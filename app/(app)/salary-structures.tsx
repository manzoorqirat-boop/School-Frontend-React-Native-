...
export default function SalaryStructures() {
  ...
  function deactivate(s: any) {
    Alert.alert('Deactivate structure',
      `Deactivate the salary structure for ${nameFor(s.teacherId)}? Payslips already generated keep their own copy of the figures.`, [
...
const styles = StyleSheet.create({
  ...
  // Stacked, not side-by-side: two numeric inputs with labels like
  // "Income tax (% of gross)" clip badly at ~170px on a phone.
