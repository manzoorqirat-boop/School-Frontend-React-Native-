...
export default function StaffReportCards() {
  ...
  async function doExport() {
    ...
    try {
      ...
      toast.success('Exported', 'Choose where to send the report card.');
              ...
              {exams.map((ex, i) => (
                <Card key={i}>
                  ...
                  <View style={styles.tableHead}>
                    ...
                    <Text style={[styles.th, { width: 66, textAlign: 'right' }]}>Marks</Text>
                    <Text style={[styles.th, { width: 44, textAlign: 'right' }]}>Grade</Text>
                  </View>
                  {(ex.subjects ?? []).map((sub: any, k: number) => {
                    ...
                    return (
                      <View key={k} style={styles.tr}>
                        ...
                        <Text style={[styles.td, { width: 44, textAlign: 'right', fontWeight: '700' },
...
const styles = StyleSheet.create({
  ...
  row: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm, paddingVertical: 11,
    minHeight: 52, borderBottomWidth: 1, borderBottomColor: colors.line },
